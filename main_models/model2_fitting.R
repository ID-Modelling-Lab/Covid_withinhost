...
param_to_save = c("beta_par", "c_par", "gamma_par", "omega_par", "theta", 
                  "omega_mod", "log_lik", "sumloglike", "R0", "R0_imm")

rstan_options(disable_march_warning = TRUE)
test = stan("model2.stan",
            data = dfst, 
            chains = 4,
            iter = 3000, 
            warmup = 1500,
...
# save test
saveRDS(test, "model2_delta_op.rds")
...
# save test
saveRDS(test, "model2_omicron_op.rds")
