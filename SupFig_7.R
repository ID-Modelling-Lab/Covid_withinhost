...
# =================================================================== #
# SF 7
# First swab of each patient dataset
# =================================================================== #
# load rds files (model fits)
model2_delta_op <- readRDS("op_SA_1sampperpat_d.rds")
model2_omicron_op <- readRDS("op_SA_1sampperpat_o.rds")

# load rdata file for vaccination regime and age group labelling
load("labels_1sampperpat.RData")
...
ggsave("viraloutput_1sampperpat_delta.png", 
...
ggsave("viraloutput_1sampperpat_omicron.png", 
...
# =================================================================== #
# SF 8
# Only patients with one swab dataset
# =================================================================== #
# load rds files (model fits)
model2_delta_op <- readRDS("op_SA_patswith1_d.rds")
model2_omicron_op <- readRDS("op_SA_patswith1_o.rds")

# load rdata file for vaccination regime and age group labelling
load("labels_1sampleonly.RData")
...
ggsave("viraloutput_1samps_delta.png", 
       plot = wrap_elements(viral.output.d.plot),
       width = 8000, height = 7500, units = "px", dpi = 700)
...
ggsave("viraloutput_1samps_omicron.png", 
       plot = wrap_elements(viral.output.o.plot),
       width = 8000, height = 7500, units = "px", dpi = 700)
...
# =================================================================== #
# load rds files (model fits)
model2_delta_op <- readRDS("op_SA_ip_d.rds")
model2_omicron_op <- readRDS("op_SA_ip_o.rds")

# load rdata file for vaccination regime and age group labelling
load("labels_swapIP.RData")
...
ggsave("viraloutput_ip_delta.png", 
       plot = wrap_elements(viral.output.d.plot),
       width = 8000, height = 7500, units = "px", dpi = 700)
...
ggsave("viraloutput_ip_omicron.png", 
       plot = wrap_elements(viral.output.o.plot),
       width = 8000, height = 7500, units = "px", dpi = 700)
